...
import { CheckCircle2, Sparkles, ArrowRight, ShieldAlert, X, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        {/* Glow Header */}
        <div className="absolute -top-12 left-1/2 h-28 w-56 -translate-x-1/2 rounded-full bg-emerald-500/20 blur-2xl" />
        ...
        <div className="relative text-center">
          ...
          <h2 className="font-display text-2xl font-bold text-white">
            {isSw ? '🎉 Hongera!' : '🎉 Congratulations!'}
          </h2>

          <p className="mt-1 text-xs text-slate-400">
            {isSw ? 'Umekamilisha kazi ya:' : 'You completed:'}
          </p>
        ...
        {/* Reward Box */}
        <div className="mt-4 rounded-xl border border-emerald-500/30 bg-emerald-950/20 p-3.5 text-center">
          ...
          <div className="mt-2.5 border-t border-emerald-500/20 pt-2 text-[11px] text-slate-400">
            {isSw
              ? 'Reward yako imeongezwa kwenye:'
        ...
        <div className="mt-4 rounded-xl border border-pink-500/40 bg-pink-950/20 p-4 shadow-[0_0_20px_rgba(244,63,94,0.15)]">
          ...
          <div className="mt-3 flex items-center justify-between border-t border-pink-500/20 pt-2.5">
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl border border-slate-700 bg-slate-800/80 py-2.5 text-xs font-semibold text-slate-300 hover:bg-slate-800 hover:text-white"
        >
          <span>{isSw ? 'Continue Tasks (Endelea na Kazi)' : 'Continue Completing Tasks'}</span>
